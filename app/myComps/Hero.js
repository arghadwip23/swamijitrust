  ...
  return (
    <section className=' pt-20 md:pt-4 min-h-[60vh] w-full flex justify-between '>
        <div className='flex flex-col justify-center text-left items-center flex-1 px-4 w-full '>
            ...
            <div className=' w-full flex gap-4 align-middle items-center justify-center mt-6 mb-10 pl-6'>
            ...
            <Button size="lg" variant="link" className="text-lg underline">second action <ArrowRight className='text-xl' size={30} /> </Button>
             ...
             <TrustBadges />
            <div className=' hidden w-full  justify-between mt-10 gap-2 md:px-8 md:mt-20 lg:px-12 lg:mt-30'>
